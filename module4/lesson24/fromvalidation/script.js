function validate(e) {
    e.preventDefault(); // e is an event , e.preventdefault will stop the form from reloading.
...
document.getElementById("email").oninput = () => validate({ preventDefault: () => { } }); //prevent default stops the form from reloading 
